...
bool getPlayerInput (/*ifstream& iplayerChar, ofstream& saveGame*/ string& input) {
		if (input == "test") {
			cout << "This is general input" << endl;
			return true;
		}
		else if (input == "quit") {
			cout << "Quitting" << endl; /*TODO: Implement save functionality (probably in a function nested within getPlayerInput)*/
            //iplayerChar.close(); 
			...
			cout << "This is either room-specific or invalid input" << endl;
			return false;
		}
    }
...
int room() {
    map<int, roomFunction> roomMap = {
		{1, std::bind(&Room::room1, this)},
...
int main(){
    ...
    cout << "Greetings, "; cout << playerNameDestination << endl << endl;; /*TODO: Fix player name not printing*/
    gameStarted = true;
